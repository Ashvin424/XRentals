...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE rooms SET title = ?, description = ?, price = ?, location = ?, contact_phone = ?, contact_email = ?, contact_whatsapp = ?, image_path = ? WHERE id = ? AND user_id = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ssdsssssii", $title, $description, $price, $location, $contact_phone, $contact_email, $contact_whatsapp, $image_path, $room_id, $_SESSION["id"]);
